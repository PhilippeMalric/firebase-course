...
import { selectddCatCode, selectddCatLabel, selectddCatVarName, selectddVarDesc, selectddVarName, selectno_na, selectVarName } from 'src/app/Rxjs/reducers';
import { updateVarName } from 'src/app/Rxjs/actions/main.actions';
