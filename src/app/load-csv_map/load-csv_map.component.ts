...
import { addData, updateData, updateFileMeta, updateFileName, updateFileName_map, updateFileSize, updateInterval } from '../actions/main.actions';
import { selectFileName, selectFileName_map } from '../reducers';
